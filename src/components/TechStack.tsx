  ...
  return (
    ...
    <div className="bg-gradient-to-b from-pink-100 to-white py-12 px-6 text-center flex justify-center items-center">
      <div className="max-w-7xl w-full">
        <h2 className="text-4xl font-extrabold text-center text-[#FF2A53] mb-6 pb-10">Customized IT Services to Elevate Your Business </h2>

        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 justify-center items-center mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 justify-center w-[1300px] mx-auto">
          <div className="flex flex-col items-center text-center w-full p-6 bg-black rounded-2xl shadow-lg hover:shadow-2xl transition-transform transform hover:scale-105 border-2 border-red-500 hover:shadow-lg hover:shadow-[#FF2A53] bg-cover bg-center relative"
          style={{ backgroundImage: `url(${img1})` }}
        >
        <div className="absolute inset-0 bg-black opacity-50 rounded-2xl"></div> {/* Added opacity */}
        ...
        <p className="text-gray-300 text-sm pt-20 relative z-10">
          ...
          <div 
            className="flex flex-col items-center text-center w-[600px] h-[300px] p-6 bg-black rounded-2xl shadow-lg hover:shadow-2xl transition-transform transform hover:scale-105 border-2 border-red-500 hover:shadow-lg hover:shadow-[#FF2A53] bg-cover bg-center"
          ...
          >
            ...
            We provide full travel support to ensure a smooth and memorable journey. From itinerary planning to booking accommodations and transportation, we make travel stress-free and enjoyable, offering expert guidance every step of the way.
              ...
              >
                ...
                <p className="text-gray-300 text-sm"><br/><br/><br/>The Internet of Things (IoT) connects devices to collect and share data, enabling smarter, more efficient living. It automates tasks and improves convenience in homes, cities, and industries.</p>
              </div>
            </div>
          </div>
        </div>
