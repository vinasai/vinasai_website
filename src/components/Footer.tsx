          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div>
              ...
              <ul className="space-y-2">
                ...
                <li><a href="#showcase" className="text-red-500 hover:text-red-600 transition-colors">Showcase</a></li>
                <li><a href="#feedbacks" className="text-red-500 hover:text-red-600 transition-colors">Feedbacks</a></li>
                <li><a href="#explore" className="text-red-500 hover:text-red-600 transition-colors">Explore</a></li>
              </ul>
            </div>
            <div>
              <h3 className="text-xl font-semibold mb-4 text-red-600">Follow Us</h3>
              <div className="flex space-x-6">
                <a href="#" className="text-red-500 hover:text-red-600 transition-colors transform hover:scale-110">Twitter</a>
                <a href="#" className="text-red-500 hover:text-red-600 transition-colors transform hover:scale-110">Github</a>
                <a href="#" className="text-red-500 hover:text-red-600 transition-colors transform hover:scale-110">LinkedIn</a>
              </div>
              <div className="mt-4">
                <h4 className="text-lg font-semibold text-red-600">Contact Details</h4>
                <p className="text-red-500 mt-2">Phone: +1 (234) 567-890</p>
